...
# No .master usage here while creating sparksession because we want dataproc to use config from dataproc only
spark = SparkSession.builder.appName('local_cluster').getOrCreate()
